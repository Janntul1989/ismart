                    ...
                    <fieldset>
                        ...
                        <div class="form-group mb-3">
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="radio" value="animal" name="animal_type"
                                    id="animal" checked>
                                <label class="form-check-label" for="animal">পশু</label>
                                <select class="form-select form-select-animal" name="animal"
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" value="bird" name="animal_bird"
                                    id="bird">
                                <label class="form-check-label" for="bird">
                                    পাখি</label>
                                <select class="form-select form-select-bird" name="bird"
                                    aria-label=".form-select-bird">
                                    <option value="" selected>নির্বাচন করুন</option>
                        ...
                        <div class="form-group mb-3">
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="radio" value="farm" name="animal_farmer"
                                    id="farmer">
                                <label class="form-check-label" for="farmer">খামারি</label>
                                <select class="form-select form-select-farmer" name="farm"
                                    aria-label=".form-select-farm">
                                    <option value="" selected>নির্বাচন করুন</option>
